...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_m_PlayerCurrentHealth_MetaData[];
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_m_PlayerCurrentHealth;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAirSnooperCharacter_Statics::NewProp_m_PlayerCurrentHealth_MetaData[] = {
		{ "Category", "Character" },
		{ "ModuleRelativePath", "AirSnooperCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AAirSnooperCharacter_Statics::NewProp_m_PlayerCurrentHealth = { "m_PlayerCurrentHealth", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AAirSnooperCharacter, m_PlayerCurrentHealth), METADATA_PARAMS(Z_Construct_UClass_AAirSnooperCharacter_Statics::NewProp_m_PlayerCurrentHealth_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AAirSnooperCharacter_Statics::NewProp_m_PlayerCurrentHealth_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAirSnooperCharacter_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAirSnooperCharacter_Statics::NewProp_m_PlayerCurrentHealth,
	};
	...
	IMPLEMENT_CLASS(AAirSnooperCharacter, 896372539);
